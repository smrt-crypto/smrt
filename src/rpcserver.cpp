...
#ifdef ENABLE_WALLET
        {"smrt", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use smrtd, or the -server option to smrt-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
