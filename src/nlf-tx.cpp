...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("nlf Core nlf-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  nlf-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded nlf transaction") + "\n" +
                               "  nlf-tx [options] -create [commands]   " + _("Create hex-encoded nlf transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded nlf transaction
