...
int64_t GetMasternodePayment(int nHeight, int64_t blockValue, int nMasternodeCount)
{
	...
	if (nHeight == 0) {
		...
		ret = 6.5 * COIN;
	} else if (nHeight < 5316  && nHeight >= 3987) {
		ret = 65 * COIN;
	} else if (nHeight < 6645  && nHeight >= 5316) {
		ret = 71.5 * COIN;
	} else if (nHeight < 7974  && nHeight >= 6645) {
		ret = 78 * COIN;
	} else if (nHeight < 9303  && nHeight >= 7974) {
		ret = 84.5 * COIN;
	} else if (nHeight < 10632  && nHeight >= 9303) {
		ret = 91 * COIN;
	} else if (nHeight < 11961  && nHeight >= 10632) {
		ret = 97.5 * COIN;
	} else if (nHeight < 13290  && nHeight >= 11961) {
		ret = 104 * COIN;
	} else if (nHeight < 14619  && nHeight >= 13290) {
		ret = 110.5 * COIN;
	} else  {
		ret = 117 * COIN;
	}
