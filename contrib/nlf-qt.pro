...
RESOURCES += src/qt/nlf.qrc src/qt/nlf_locale.qrc

TRANSLATIONS += src/qt/locale/nlf_bg.ts \
                src/qt/locale/nlf_de.ts \
                src/qt/locale/nlf_en.ts \
                src/qt/locale/nlf_es.ts \
                src/qt/locale/nlf_fi.ts \
                src/qt/locale/nlf_fr.ts \
                src/qt/locale/nlf_it.ts \
                src/qt/locale/nlf_ja.ts \
                src/qt/locale/nlf_pl.ts \
                src/qt/locale/nlf_pt.ts \
                src/qt/locale/nlf_ru.ts \
                src/qt/locale/nlf_sk.ts \
                src/qt/locale/nlf_sv.ts \
                src/qt/locale/nlf_vi.ts \
                src/qt/locale/nlf_zh_CN.ts \
                src/qt/locale/nlf_zh_TW.ts
