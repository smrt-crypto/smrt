...
In order to support loading of multiple wallets in smrt-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is smrt.cpp.
...
Changes to smrt.cpp
----------------------
smrt.cpp is the entry point into smrt-qt, and as such, will require some minor modifications to provide hooks for
