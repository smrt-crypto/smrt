Contributing to SMRT Core
============================

The SMRT Core project operates an open contributor model where anyone is
...
The following applies to code changes to the SMRT Core project, and is not to be
confused with overall SMRT Network Protocol consensus changes.

Whether a pull request is merged into SMRT Core rests with the project merge
...
Patches that change SMRT consensus rules are considerably more involved than
...
Where a patch set proposes to change the SMRT consensus, it must have been
...
The project leader is the release manager for each SMRT Core release.
